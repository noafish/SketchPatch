    ...
    def __getitem__(self, index):
        ...
        if self.opt.flip_and_rotate:
            ...
            if rot < 0.5:
                ...
                A_img = ndimage.rotate(A_img, ang, reshape=False)
                B_img = ndimage.rotate(B_img, ang, reshape=False)

            A_img = self.ndarrayToPilImage(A_img)
            B_img = self.ndarrayToPilImage(B_img)
